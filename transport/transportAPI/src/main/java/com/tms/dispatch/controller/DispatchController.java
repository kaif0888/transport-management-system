...
public class DispatchController {
	...
	@PutMapping("/dispatchUpdateByDriverPiksUp/{id}")
	public ResponseEntity<DispatchBean> dispatchUpdateByDriverPiksUp(
	        @PathVariable("id") String dispatchId,
	        @RequestParam("location") String activeLocation) {

	    DispatchBean updatedDispatch = dispatchService.dispatchUpdateByDriverPiksUp(dispatchId, activeLocation);
	...
	@PutMapping("/updateDispatchById/{id}")
	public ResponseEntity<DispatchBean> updateDispatchById(@PathVariable("id") String dispatchId,
