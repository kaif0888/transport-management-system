...
public class EmployeeController {
	...
	public EmployeeBean getById(@PathVariable String employeeId) {
	...
	public List<EmployeeBean> getEmployeeAccordingToUserInput(@RequestParam(required = false) String employeeId) {

		return employeeService.getEmployeeAccordingToUserInput(employeeId);
	}
	
	@PostMapping("/listOfOrderByFilterCriteria")
