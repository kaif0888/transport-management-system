...
//		String username = auth.getName();
	...
	public ResponseEntity<CustomerBean> getCustomerById(@PathVariable String customerId) {
		try {
	...
	public ResponseEntity<CustomerBean> updateByCustomerId(@PathVariable("id") String id,
