...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
	    ...
	    return path.startsWith("/api/v1/auth/") ||
	           ...
	           path.startsWith("/vehiclestms/")||
	           path.startsWith("/drivers/") ||
	           path.startsWith("/rental/")||
	    path.startsWith("/swagger-ui/") ||
        path.startsWith("/v3/api-docs/") ||
        path.startsWith("/vehiclestms/") ||  path.startsWith("/location/") ||
        path.startsWith("/drivers/") ||    path.startsWith("/customer/") ||  path.startsWith("/order/") ||
        path.startsWith("/rental/")||   path.startsWith("/bookingCost/")||
	          path.startsWith("/dispatch/")|| path.startsWith("/expenseType/") ||
	          path.startsWith("/expense/")|| path.startsWith("/employee/") || path.startsWith("/payment/") ||  path.startsWith("/invoice/");
