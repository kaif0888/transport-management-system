...
public class ProductCategoryController {
    ...
    public ProductCategoryBean getCategoryById(@PathVariable Long id) {
    ...
    public ResponseEntity<ProductCategoryBean> updateByCategoryId(@PathVariable("id") Long id, @RequestBody ProductCategoryBean bean) {
        try {
