...
public class BranchController {
    ...
    public ResponseEntity<BranchBean> getBranchById(@PathVariable("id") Long id) {
        try {
    ...
    @ApiOperation(value = "Get all branches and locations", response = BranchLocationResponse.class, notes = "Fetch all branches along with locations")
    ...
    public ResponseEntity<BranchBean> updateByBranchId(@PathVariable("id") Long id, @RequestBody BranchBean branchBean) {
        try {
